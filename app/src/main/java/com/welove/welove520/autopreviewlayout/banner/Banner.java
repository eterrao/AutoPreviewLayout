package com.welove.welove520.autopreviewlayout.banner;
...
import com.welove.welove520.autopreviewlayout.banner.listener.OnBannerClickListener;
import com.welove.welove520.autopreviewlayout.banner.loader.ImageLoaderInterface;
import com.welove.welove520.autopreviewlayout.banner.widget.BannerViewPager;
...
public class Banner extends FrameLayout implements OnPageChangeListener {
     ...
     * Banner 底边距
     */
    private int mIndicatorMarginBottom = BannerConfig.MARGIN_BOTTOM;
    /**
     * Banner Indicator 宽/高,可为 ViewGroup.LayoutParams.WRAP_CONTENT,也可以是普通的integer
     */
    ...
    private void handleTypedArray(Context context, AttributeSet attrs) {
        ...
        paddingLeft = typedArray.getDimensionPixelSize(R.styleable.Banner_vp_padding_left, 0);
        paddingRight = typedArray.getDimensionPixelSize(R.styleable.Banner_vp_padding_right, 0);
        paddingTop = typedArray.getDimensionPixelSize(R.styleable.Banner_vp_padding_top, 0);
        paddingBottom = typedArray.getDimensionPixelSize(R.styleable.Banner_vp_padding_bottom, 0);
        typedArray.recycle();
    }
    ...
    public void setCardPadding(int left, int top, int right, int bottom) {
        if (viewPager != null) {
            int paddingLeft = (int) TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP, left, getResources().getDisplayMetrics());
            int paddingTop = (int) TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP, top, getResources().getDisplayMetrics());
            int paddingRight = (int) TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP, right, getResources().getDisplayMetrics());
            int paddingBottom = (int) TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP, bottom, getResources().getDisplayMetrics());
            viewPager.setPadding(paddingLeft, paddingTop, paddingRight, paddingBottom);
        }
    }
    ...
    public void setCardMargin(float margin) {
        if (viewPager != null) {
            ...
            viewPager.setPageMargin(cardMargin);
        }
    }
...
//            createIndicator();
    ...
    private void createIndicator() {
        ...
        for (int i = 0; i < count; i++) {
            ...
            imageView.setPadding(0, 0, 0, mIndicatorMarginBottom);
...
//        Log.i(tag, ev.getAction() + "--" + isAutoPlay);
    ...
    public int getIndicatorSelectedResId() {
        return mIndicatorSelectedResId;
    }
    ...
    public int getIndicatorUnselectedResId() {
        return mIndicatorUnselectedResId;
    }
